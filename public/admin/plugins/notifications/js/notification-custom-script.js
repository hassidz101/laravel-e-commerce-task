...
function img_default_noti() {
	Lobibox.notify('default', {
		...
		continueDelayOnInactiveTab: false,
		position: 'top right',
		img: 'admin/plugins/notifications/img/1.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_info_noti() {
	Lobibox.notify('info', {
		...
		icon: 'bx bx-info-circle',
		position: 'top right',
		img: 'admin/plugins/notifications/img/2.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_warning_noti() {
	Lobibox.notify('warning', {
		...
		continueDelayOnInactiveTab: false,
		position: 'top right',
		img: 'admin/plugins/notifications/img/3.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_error_noti() {
	Lobibox.notify('error', {
		...
		icon: 'bx bx-x-circle',
		position: 'top right',
		img: 'admin/plugins/notifications/img/4.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
...
function img_success_noti() {
	Lobibox.notify('success', {
		...
		position: 'top right',
		icon: 'bx bx-check-circle',
		img: 'admin/plugins/notifications/img/5.jpg', //path to image
		msg: 'Lorem ipsum dolor sit amet hears farmer indemnity inherent.'
	});
}
/* Notifications With Images*/
